...
model = YOLO("first_model_ncnn_model")
#model = YOLO("first_model_float32.tflite", task="detect")
#model = YOLO("first_model_int8_openvino_model")
#model = YOLO("first_model.onnx")
